...
from .midi_dataset import DatasetConstructor, MIDIAnnotations, MusicNetAnnotations
...
class CQTMaestroDatasetConstructor(DatasetConstructor):
    @override
    def procedure(
        self,
        data_path: str,
    ...
    def annotation_procedure(
        ...
        annotations = MIDIAnnotations.from_midi(path).to_frames(
            fs=fs, num_frames=num_frames, frame_shift=frame_shift
        )
        annotations = (
            FrameSeries(annotations).trim_by_value(*trim)
